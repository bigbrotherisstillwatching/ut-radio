   ...
   Column {
      ...
      Rectangle {
         ...
         TextArea {
            ...
            placeholderText: i18n.tr("Metadata is shown here. You can also show, edit & save station name & URL as well as the image URL by swiping to the left in the favourite list.")
         }
      }
               ...
               Action {
                  ...
                  onTriggered: {
                     ...
                     if (favouriteModel.get(index).stationID === lastStation.stationID) {
                        lastStation.favourite = !lastStation.favourite
                        favIcon.iconName = lastStation.favourite ? "non-starred" : "starred"
