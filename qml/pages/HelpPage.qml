...
//            anchors.top: image1.bottom
         ...
         Text {
            id: text1
            text: i18n.tr("<font color=\"#FF0000\">(1)</font> Metadata is shown here. aaaaaa aaaaaaaa aaaa aaaaaa aaa aaaaaaaa aaaaaaaaaaa aaaaaa aaaaa aaaaaaa aaaa aaaaa aaaaaa aaaaaaaaaaaa aaaaaaaa")
            font.pointSize: 25
