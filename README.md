...
-for now, when the equalizer is activated and you change sound output from e.g. bluetooth speakers to internal speakers you better turn off the equalizer before changing output and restart the app...i try to find solutions for all eventualities...      
